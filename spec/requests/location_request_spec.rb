...
RSpec.describe "Location request", :type => :request do
  ...
  describe "User can create an event and renders the event's page" do
    it "creates an event and redirects to the event listt" do
      get new_location_path
      expect(response).to render_template(:new)

      location = Location.create(street1: "some_street", city: "some_city", zip: "some_zipcode", latitude: 0.00, longitude: 0.00, events_attributes: [ name: "some_name", date: "2001-12-03", time: "2015-12-08 10:26:40 -0200", location_id: 4, activity_id: 4 ] )
